...
const Navbar: FC<NavbarProps> = async () => {
	...
	return (
		<header className="w-full sticky top-0 z-20 bg-white/40 dark:bg-neutral-950/40 backdrop-blur-md h-20 border-b border-neutral-600">
			<Container className="w-full h-20 flex justify-between items-center">
